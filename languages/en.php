<?php 
	$english = array(
		...
		// Settings
		'group_custom_style:settings:metadata_key' => "Metatdata field name",
		'group_custom_style:settings:metadata_value' => "Metadata field value",
		...
		'group_custom_layout:action:save:error:background' => "Error while saving background image",
